...
def main(argv):
    ...
    parser.add_argument('--service_off', dest='service_off', action='store', help='Off line Service. Provide Service ID or Name', required=False)
    parser.add_argument('--service_on', dest='service_on', action='store', help='On line Service. Provide Service ID or Name', required=False)
