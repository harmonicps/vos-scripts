...
for svitem in sv:
    ...
    print '*'.join((sv_name,sv_id,sv_state,sr_name,sr_p_name,sr_p_ver,sv_prof_id,sv_sour_id,sr_cl,sr_clid,sr_sip,sr_mip,sr_udp,d_name,sv_dest_id,d_type,d_ip,d_udp,d_cl,d_eclid,d_p_name,d_p_ver,d_prof_id))
